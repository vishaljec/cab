...
import com.hcs.adapter.NavigationDrawerAdapter;
import com.hcs.beans.NavDrawerItem;
import com.hcs.constants.ApplicationConstants;
 
public class FragmentDrawer extends Fragment implements ApplicationConstants{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        TextView  phoneNumber=(TextView) layout.findViewById(R.id.phoneNumber);
        SharedPreferences sharedpreferences= 	sharedpreferences = getActivity().getSharedPreferences("login", Context.MODE_PRIVATE);
